...
var Base = Object.create(Object.prototype, {
  ...
  extendAndCreate: {
    value: function(args, props) {
      var obj = this.extend(props);
      obj.initialize.apply(obj, args);
      return obj;
    }
  },

  extendWithDescriptorsAndCreate: {
    value: function(args, descriptors) {
      var obj = this.extendWithDescriptors(descriptors);
      obj.initialize.apply(obj, args);
      return obj;
    }
  },
